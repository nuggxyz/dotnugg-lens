...
var ipc_listener_1 = __importDefault(require("./ipc-listener"));
var Main = /** @class */ (function () {
                ...
                submenu: [
                    {
                        ...
                        click: function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.shell.openExternal('https://www.nugg.xyz')];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    },
                    {
                        ...
                        click: function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.shell.openExternal('https://app.nugg.xyz')];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    Main.main = function (app, ipcMain, autoUpdater, shell, dialog, browserWindow, menu, _dotnugg) {
        ...
        this.shell = shell;
        this.dialog = dialog;
        this.dotnugg = dotnugg_sdk_1.dotnugg;
        ipc_listener_1["default"].register(this);
    };
    Main.APP_NAME = 'lens/main';
    Main.DEFAULT = 'lensDefault';
    return Main;
}());
